    ...
    return (
        <Stage x={stage[0]} y={stage[1]} width={stage[2]} height={stage[3]}>
            <Layer>
                ...
                <Text x={60} y={40} text="Triangle: the base" fontSize={18} />
                <Text x={80} y={40} text="Green Line: Rover Path" fontSize={18} />
                <Text x={100} y={40} text="Red -> White Fill: Indicate radar readings" fontSize={18} />
